...
$LargeTvFiles = Get-ChildItem $TvShowDir -recurse -Exclude $TVExcludeList | where-object {$_.length -gt $TvShowSize}  | Select-Object FullName,Directory,BaseName,Length
